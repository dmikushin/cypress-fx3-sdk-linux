...
---------------------------------------------
  ...
  3. The CY_FX_NUMBER_OF_ADDR_LINES defines the number of socket and the
     ...
     value from 2 to 5. The number of sockets and bulk endpoints are defined
     using the equation:
  ...
  Files:
    ...
    * cyfxslfifoasync.h     : C header file that defines constants used by
                              this example implementation. Can be modified to
                              select USB connection speed, endpoint numbers,
                              properties etc.

    * cyfxslfifoasync5bit.c : Main source file that implements this application.
                              Initializes all relevant FX3 hardware blocks and
                              sets up the DMA channels required.
    ...
    * cyfxgpif_asyncsf.h    : C header file that contains the data required
                              ...
                              Asynchronous Slave FIFO 5 Bit protocol.

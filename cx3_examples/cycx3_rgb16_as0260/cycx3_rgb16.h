/*
## Cypress USB 3.0 Platform header file (cycx3_rgb16.h)
## ===========================
##
...
#ifndef _INCLUDED_CYCX3_RGB16_H_
#define _INCLUDED_CYCX3_RGB16_H_
...
#define CX3_UVC_DATA_BUF_SIZE                   (0x2FF0)        /* DMA Buffer Data Size Used: 12272 Bytes*/
...
/* UVC Buffer count */
#define CX3_UVC_STREAM_BUF_COUNT                (8)
...
extern const uint8_t glQvga90ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING];
extern const uint8_t glVga60ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING];
extern const uint8_t glQvga5ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING];
...
#endif /* _INCLUDED_CYCX3_RGB16_H_ */

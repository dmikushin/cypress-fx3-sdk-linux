/*
## Cypress USB 3.0 Platform source file (cycx3_rgb16.c)
## ===========================
##
...
/* This application example implemnets a RGB565 video camera over the UVC 1.1 prorocol.on the CX3 using an

/*
## Cypress USB 3.0 Platform source file (cycx3_dscr.c)
## ===========================
##
...
const uint8_t CyCx3USBSSConfigDscr[] =
{
    ...
    0x03,                               /* Number of Frame Descriptors that follow this descriptor: 2 */
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
   ...
   /* Class specific Uncompressed VS Frame Descriptor 1 - 320x240@90fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype: Uncompressed frame interface*/
    0x01,                               /* Frame Descriptor Index: 1 */
...
uint8_t const glQvga90ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
...
uint8_t const glQvga5ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
    0x01,                               /* Use 1st Video format index */
    0x01,                               /* Use 2nd Video frame index */
